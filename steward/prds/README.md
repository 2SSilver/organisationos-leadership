...
Across the set: 22 ENFORCED · 42 SHIPPED · 42 CONVENTION · 1 GAP, out of 107 requirements total. (2026-09-18, reflecting findings N1, N2 and N5 closed 2026-09-15: FR-05.2 moved `ENFORCED (local)` → `ENFORCED (CI)`, no change to this count; FR-13.4 and FR-16.4 each moved `SHIPPED` → `CONVENTION` — see Pattern F below.)
